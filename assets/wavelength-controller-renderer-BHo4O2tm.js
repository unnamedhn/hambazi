import{h as K,t as d,e as v,f as W}from"./utils-DwvgUve0.js";import{g as U}from"./theme-registry-DnI3cy_m.js";import{c as x,d as Y}from"./ui-components-Dv-0K--_.js";import{b as r,W as y}from"./wavelength-constants-Dzyp9o5y.js";import"./howler-DacRvduY.js";const E=new Map,T=new Map,_=new Map;let L=null,$=null,p=null,R=null;const M="تلویزیون را نگاه کن",q="رتبه شما";function on(n,t,e,i){switch(R=`${n}:${m(t)}`,n){case"intro":P(t,e,i);break;case"psychic-clue":F(t,e,i);break;case"guessing":Q(t,e,i);break;case"reveal":X(t,e,i);break;case"game-end":j(t,e,i);break;case"lobby":break;default:console.warn(`Unknown phase for Wavelength controller renderer: ${n}`)}}function P(n,t,e){h(),G(e),w(e,r.INTRO),e.timer.textContent="",e.challengeInfo.textContent=n.psychicId===t?r.YOU_ARE_PSYCHIC:`${r.PSYCHIC}: ${n.psychicName||""}`,e.challengeQuestion.innerHTML=J(n),e.optionsContainer.innerHTML=C(r.WAITING)}function F(n,t,e){if(G(e),O(n,e,r.PSYCHIC_CLUE),e.challengeQuestion.innerHTML="",n.psychicId!==t){h(),e.optionsContainer.innerHTML=C(r.WAITING_FOR_PSYCHIC);return}A(n,t,e)}function Q(n,t,e){var i,u,o;if(G(e),O(n,e,r.GUESSING),e.challengeQuestion.innerHTML=`
