import{g as O}from"./theme-registry-qFAuYK91.js";import{c as f,d as g}from"./ui-components-Tk9G7nUf.js";import{t as a,e as c}from"./utils-CtiNnZvt.js";import{T as t,C as N}from"./tap-race-constants-1J7RIRMW.js";import"./howler-DacRvduY.js";const d="تلویزیون را نگاه کن",m="روی گوشی جواب بده",I="پاسخت ثبت شد",w="رتبه شما";let _=new Map,u=!1,C=null,T=null;function B(n,e,r,i,o){switch(n){case"lobby":break;case"challenge-start":M(e,i);break;case"challenge-observe":L(e,i);break;case"challenge-answer":case"challenge-active":H(e,r,i);break;case"challenge-result":x(e,r,i);break;case"game-end":k(e,r,i);break;default:console.warn(`Unknown phase for Tap Race controller: ${n}`)}}function L(n,e){var r,i;const o=n.currentChallengeIndex+1,s=((r=n.currentChallenge)==null?void 0:r.id)||"",l=C!==s;b(e),l&&(u=!1,C=s),T=n.phase,E(e,`${t.CHALLENGE} ${a(o.toString())}`,d),e.timer.textContent=$(n.timeRemaining),e.challengeInfo.textContent="",e.challengeQuestion.innerHTML=`
