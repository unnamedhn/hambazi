import{g as N}from"./theme-registry-C69X5mSl.js";import{c as b,d as g}from"./ui-components-Tk9G7nUf.js";import{t as a,e as c}from"./utils-CtiNnZvt.js";import{T as r,C as m}from"./tap-race-constants-CdinSpZC.js";import"./howler-DacRvduY.js";const p="تلویزیون را نگاه کن",w="روی گوشی جواب بده",I="پاسخت ثبت شد",M="رتبه شما";let f=new Map,l=!1,T=null,v=null;function B(n,e,t,i,o){switch(n){case"lobby":break;case"challenge-start":H(e,i);break;case"challenge-observe":L(e,i);break;case"challenge-answer":case"challenge-active":x(e,t,i);break;case"challenge-result":k(e,t,i);break;case"game-end":y(e,t,i);break;default:console.warn(`Unknown phase for Tap Race controller: ${n}`)}}function L(n,e){var t,i;const o=n.currentChallengeIndex+1,s=((t=n.currentChallenge)==null?void 0:t.id)||"",d=T!==s;E(e),d&&(l=!1,T=s),v=n.phase,_(e,`${r.CHALLENGE} ${a(o.toString())}`,p),e.timer.textContent=O(n.timeRemaining),e.challengeInfo.textContent="",e.challengeQuestion.innerHTML=`
