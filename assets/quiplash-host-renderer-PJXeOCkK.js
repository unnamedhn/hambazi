import{h as m,t as d,e as u,f as S}from"./utils-DwvgUve0.js";import{b as $,r as b,a as R}from"./ui-components-Dv-0K--_.js";import{b as s}from"./quiplash-constants-BzTlauqg.js";import"./howler-DacRvduY.js";import"./theme-registry-DnI3cy_m.js";function T(t,n,r,e){const i=r.filter(o=>!o.isHost);switch(t){case"prompt":x(n,e);break;case"write-answer":y(n,i,e);break;case"vote":C(n,i,e);break;case"reveal":w(n,i,e);break;case"game-end":P(n,i,e);break;default:console.warn(`Unknown phase for Quiplash host renderer: ${t}`)}}function A(t,n,r){T(t.phase,t,n.filter(e=>!e.isHost),r)}function x(t,n){var r;v("challenge",n),h(t,n,s.PROMPT),n.challengeContent.innerHTML=`
