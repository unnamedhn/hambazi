import{j as C,t as a,e as d,f as G}from"./utils-CFEGV26U.js";import{b as y,r as $,a as f}from"./ui-components-xLfVTxhZ.js";import{b as i}from"./wavelength-constants-BmADtbBI.js";import"./theme-registry-D9klAoOF.js";function T(n,e,t,r){const o=t.filter(l=>!l.isHost);switch(n){case"intro":_(e,o,r);break;case"psychic-clue":w(e,o,r);break;case"guessing":L(e,o,r);break;case"reveal":N(e,o,r);break;case"game-end":H(e,o,r);break;default:console.warn(`Unknown phase for Wavelength host renderer: ${n}`)}}function j(n,e,t){T(n.phase,n,e.filter(r=>!r.isHost),t)}function _(n,e,t){h("challenge",t),t.challengeTitle.textContent=i.INTRO,t.challengeTimer.textContent="",t.challengeProgress.textContent=R(n);const r=g(e,n.psychicId);t.challengeContent.innerHTML=`
  ...
  `}function g(n,e){return e&&n.find(t=>t.id===e)||null}function h(n,e){e.challengeContainer.classList.toggle("hidden",n!=="challenge"),e.resultsContainer.classList.toggle("hidden",n!=="results"),e.finalResults!==e.resultsContainer&&e.finalResults.classList.add("hidden")}function V(){}export{V as cleanupHandlers,j as renderGameScreen,T as renderPhase};
