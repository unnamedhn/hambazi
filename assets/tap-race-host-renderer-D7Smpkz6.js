import{b as f,r as R}from"./ui-components-Dv-0K--_.js";import{t as i,h as E,e as d}from"./utils-DwvgUve0.js";import{T as n,C as N}from"./tap-race-constants-BMM_awWD.js";import"./howler-DacRvduY.js";import"./theme-registry-DnI3cy_m.js";let g=null,p=null,$=null;function O(t,e,s,l,h){const r=S(s);switch(t){case"challenge-start":w(e,l);break;case"challenge-observe":case"challenge-answer":case"challenge-active":y(e,r,l);break;case"challenge-result":I(e,r,l);break;case"game-end":m("results",l),M(e,r,l);break;default:console.warn(`Unknown phase for Tap Race renderer: ${t}`)}}function w(t,e){m("challenge",e),g=null,p=null,$=null;const s=t.currentChallengeIndex+1;e.challengeTitle.textContent=`${n.CHALLENGE} ${i(s.toString())} ${n.OF} ${i(t.totalChallenges.toString())}`,e.challengeProgress.textContent=`${i(s.toString())}/${i(t.totalChallenges.toString())}`,e.challengeTimer.classList.remove("is-count-circle"),e.challengeTimer.textContent="",e.challengeContent.innerHTML=`
  ...
  `}function I(t,e,s){var l;m("results",s),g=null,p=null,$=null;const h=[...t.results].sort((o,c)=>c.coinsEarned-o.coinsEarned),r=((l=t.currentChallenge)==null?void 0:l.type)==="quick_trivia"?t.currentChallenge.source.title:"",v=[t.revealText,r?`منبع: ${r}`:""].filter(Boolean).join(" | ");s.resultsContainer.innerHTML=f({title:n.RESULTS,subtitle:v||void 0,highlight:t.correctAnswerText?`${n.CORRECT_ANSWER}: ${t.correctAnswerText}`:void 0,rows:h.map(o=>{const c=e.find(b=>b.id===o.playerId);if(!c)return"";const C=[o.correct?n.CORRECT:n.WRONG,o.fastest?n.FASTEST:"",o.responseTime!==null?`${n.RESPONSE_TIME}: ${H(o.responseTime)}`:""].filter(Boolean).join(" | ");return R({player:c,detail:C,reward:o.coinsEarned>0?`+${i(o.coinsEarned.toString())} ${n.COINS_EARNED}`:`0 ${n.COINS_EARNED}`,tone:o.correct?"good":"muted"})}).join("")})}function D(t,e,s){O(t.phase,t,S(e),s)}function M(t,e,s){var l,h;const r=Array.isArray(e)?S(e):[],v=s||e,o=Object.values(t.scores).sort((a,u)=>u.totalCoins-a.totalCoins||u.correctAnswers-a.correctAnswers||u.fastestAnswers-a.fastestAnswers),c=o.map(a=>a.totalCoins),C=(h=(l=o[0])==null?void 0:l.totalCoins)!=null?h:0,b=C>0?o.filter(a=>a.totalCoins===C).map(a=>{var u;return((u=r.find(T=>T.id===a.playerId))==null?void 0:u.name)||a.playerName}):[];v.resultsContainer.innerHTML=f({eyebrow:n.GAME_OVER,title:b.length>0?`${n.CHAMPION}: ${b.join(" و ")}`:n.NO_CHAMPION,subtitle:C>0?`${i(C.toString())} ${n.COINS_EARNED}`:void 0,rows:o.map(a=>{const u=r.find(A=>A.id===a.playerId)||{id:a.playerId,name:a.playerName||a.playerId,color:"#64748b"},T=[`${i(a.correctAnswers.toString())} ${n.CORRECT_ANSWERS}`,`${i(a.fastestAnswers.toString())} ${n.FASTEST_ANSWERS}`].join(" | ");return R({player:u,rank:E(c,a.totalCoins),detail:T,reward:`${i(a.totalCoins.toString())} ${n.COINS_EARNED}`,tone:E(c,a.totalCoins)===1&&a.totalCoins>0?"winner":"default"})}).join("")}),v.resultsContainer.classList.remove("hidden")}function x(t,e=!0){switch(t.type){case"object_math":return`
      ...
      `}}function S(t){return t.filter(e=>!e.isHost)}function _(t,e){return`${i(t.toString())}/${i(e.toString())} ${n.ANSWERED}`}function G(t,e){switch(e){case"challenge-start":return n.CHALLENGE;case"challenge-active":case"challenge-observe":case"challenge-answer":return n.GAME_NAME;case"challenge-result":return n.RESULTS;case"game-end":return n.GAME_OVER;default:return""}}function F(){g=null,p=null,$=null}function L(t){return i(Math.max(0,Math.ceil(t/1e3)).toString())}function H(t){const e=(t/1e3).toFixed(2).replace(".","٫");return`${i(e)} ${n.SECONDS}`}function m(t,e){e.challengeContainer.classList.toggle("hidden",t!=="challenge"),e.resultsContainer.classList.toggle("hidden",t!=="results"),t==="challenge"&&(e.challengeContent.className="board-host-game-content"),e.finalResults!==e.resultsContainer&&e.finalResults.classList.add("hidden")}export{F as cleanupHandlers,G as getTransitionMessage,D as renderGameScreen,O as renderPhase,M as renderResults};
