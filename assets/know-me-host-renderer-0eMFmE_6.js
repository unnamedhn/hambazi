import{b as v,r as b,a as $}from"./ui-components-Dv-0K--_.js";import{t as a,h as p,e as l,f as R}from"./utils-DwvgUve0.js";import{b as t}from"./know-me-constants-DyQ1hTSe.js";import"./howler-DacRvduY.js";import"./theme-registry-DnI3cy_m.js";function E(n,e,o,r){switch(n){case"intro":C(e,o,r);break;case"subject-answering":w(e,r);break;case"guessing":I(e,o,r);break;case"reveal":N(e,o,r);break;case"reaction":O(e,r);break;case"game-end":x(e,o,r);break;default:console.warn(`Unknown phase for Know Me host renderer: ${n}`)}}function U(n,e,o){E(n.phase,n,e,o)}function C(n,e,o){u("challenge",o),o.challengeTitle.textContent=t.INTRO,o.challengeTimer.classList.remove("is-count-circle"),o.challengeTimer.textContent="",o.challengeProgress.textContent=`${a(n.totalQuestions.toString())} ${t.QUESTION}`;const r=h(e,n.subjectId);o.challengeContent.innerHTML=`
  ...
  `}function x(n,e,o){u("results",o);const r=Object.values(n.scores).sort((s,c)=>c.score-s.score),i=r.map(s=>s.score);o.resultsContainer.innerHTML=v({eyebrow:t.GAME_OVER,title:t.FINAL_RESULTS,rows:r.map(s=>{const c=h(e,s.playerId)||{id:s.playerId,name:s.playerName,color:"#64748b"},d=[`${t.CORRECT} ${a(s.correctGuesses.toString())}`,`${t.SUBJECT_BONUS} ${a(s.subjectBonuses.toString())}`].join(" | ");return b({player:c,rank:p(i,s.score),detail:d,reward:`${a(s.score.toString())} ${t.POINTS}`,tone:p(i,s.score)===1&&s.score>0?"winner":"default"})}).join("")})}function S(n,e,o){const r=n.currentQuestionIndex+1;e.challengeTitle.textContent=o,e.challengeTimer.classList.add("is-count-circle"),e.challengeTimer.textContent=R(n.timeRemaining/1e3),e.challengeProgress.textContent=`${t.QUESTION} ${a(r.toString())} ${t.OF} ${a(n.totalQuestions.toString())}`}function f(n,e=!1){const o=n.currentQuestion;return o?`
  ...
  `:""}function j(n,e,o){const r=h(e,n.playerId)||{id:n.playerId,name:n.playerId,color:"#64748b"},i=o.currentQuestion,c=[i&&n.answerIndex!==null?i.options[n.answerIndex]:t.NO_ANSWER,n.correct?t.CORRECT:t.WRONG].filter(Boolean).join(" | ");return b({player:r,detail:c,reward:`+${a(n.pointsEarned.toString())} ${t.POINTS}`,tone:n.correct?"good":"muted"})}function m(n,e){const o=h(e,n.subjectId);return o?b({player:o,detail:t.SUBJECT_PICKED,reward:`+${a(n.subjectBonusEarned.toString())} ${t.SUBJECT_BONUS}`,tone:n.subjectBonusEarned>0?"good":"default"}):""}function h(n,e){return e&&n.find(o=>o.id===e)||null}function u(n,e){e.challengeContainer.classList.toggle("hidden",n!=="challenge"),e.resultsContainer.classList.toggle("hidden",n!=="results"),n==="challenge"&&(e.challengeContent.className="board-host-game-content"),e.finalResults!==e.resultsContainer&&e.finalResults.classList.add("hidden")}function B(){}export{B as cleanupHandlers,U as renderGameScreen,E as renderPhase};
