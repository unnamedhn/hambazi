import{h as f,t as l,e as u,f as y}from"./utils-DwvgUve0.js";import{b as $,r as g,a as S}from"./ui-components-Dv-0K--_.js";import{b as a}from"./fibbage-constants-CEo1QI1b.js";import"./howler-DacRvduY.js";import"./theme-registry-DnI3cy_m.js";function T(t,n,e,i){const r=e.filter(o=>!o.isHost);switch(t){case"prompt":C(n,i);break;case"write-lie":R(n,r,i);break;case"vote":x(n,r,i);break;case"reveal":I(n,r,i);break;case"game-end":E(n,r,i);break;default:console.warn(`Unknown phase for Fibbage host renderer: ${t}`)}}function V(t,n,e){T(t.phase,t,n.filter(i=>!i.isHost),e)}function C(t,n){var e;v("challenge",n),b(t,n,""),n.challengeContent.innerHTML=`
